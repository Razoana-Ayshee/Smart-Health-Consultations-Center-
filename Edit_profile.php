...
$id=$user_data['NID_no'];
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		$query="UPDATE information SET address = '$address', Gender='$Gender', contact_number='$contact_number',date_of_birth='$date_of_birth',profession='$profession',height='$height',father_name='$father_name',mother_name='$mother_name'   WHERE NID_no ='$id' ";

		//$retval = mysql_query( $con, $query );
	//$query = "insert into patient (address,age,Gender,contact_number,date_of_birth,profession,email,height,father_name,mother_name) values ('$address','$age','$Gender','$contact_number', '$date_of_birth', '$profession', '$email', '$height', '$father_name', '$mother_name') WHERE NID_no ='$NID_no'";
...
;
	...
	<div id="box">
		...
		<form method="post">
			...
			<div style="font-size: 30px;margin: 20px;color: Orange;"><?php echo $user_data['user_name']; ?> Edit Your Profile</div>
