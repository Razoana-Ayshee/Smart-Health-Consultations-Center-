...
$dateOfBirth = $user_age['date_of_birth'];
		...
		$query = "select * from designation where id = '$q' limit 1";
...
<body>
	...
	#box{
		...
		<form method="post">
			...
			<div style="font-size: 50px;margin: 20px;color: red;">Welcome <?php echo $doctor_data['name']; ?></div>

<a href="day_available.php"><input id="button" value="Insert/Edit Day Slot"></a>		
<a href="fee.php"><input id="button" value="Insert/Edit Visit Fee"></a>	<br><br>
	<a href="d_edit_profile.php"><input id="button" value="          Edit Information"></a>
		<a href="secret_code_login.php"><input id="button" value="        Give treatment"></a><br><br>
		<a href="show_doctor_app_list.php"><input id="button" value="        See All Appoinment"></a>
		<a href="dept_set.php"><input id="button" value="    Set Depertment"></a><br><br>
		<a href="d_see_rating.php"><input id="button" value="       See Ratings and Reviews"></a><br><br>

		<div id="box">	<div style="font-size: 20px;margin: 10px;color: #440932;">Full Name      : <?php echo $doctor_data['name']; ?></div></div></div>
		<div id="box">	<div style="font-size: 20px;margin: 10px;color: #440932;">Address        : <?php echo $user_info['address']; ?> </div></div>
		<div id="box">	<div style="font-size: 20px;margin: 10px;color: #440932;">Age            : <?php
...
?>  </div></div>
		...
		<div id="box">	<div style="font-size: 20px;margin: 10px;color: #440932;">Joining Date & Time   : <?php echo $doctor_data['date']; ?></div></div>
		<div id="box">	<div style="font-size: 20px;margin: 10px;color: #440932;">Designation:  <br> <?php echo $doctor_info['d1']; ?>, <br>
<?php echo $doctor_info['d2']; ?>, 	
<?php echo $doctor_info['d3']; ?> <br>
<?php echo $doctor_info['d4']; ?>, <br>
<?php echo $doctor_info['d5']; ?>, 	
<?php echo $doctor_info['d6']; ?> <br>	
<?php echo $doctor_info['job_position']; ?>			
<?php echo $doctor_info['institute']; ?> </div></div>
